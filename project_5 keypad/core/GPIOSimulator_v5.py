...
charlieplexing_pins = [PIN_CHARLIEPLEXING_0, PIN_CHARLIEPLEXING_1,
                       PIN_CHARLIEPLEXING_2]
keypad_row_pins = [PIN_KEYPAD_ROW_0, PIN_KEYPAD_ROW_1, PIN_KEYPAD_ROW_2,
                   PIN_KEYPAD_ROW_3]
...
class GPIOSimulator:
    ...
    def input(self, pin):
        """ Carry out hardware simulation and return the
        state of an input pin """
    ...
    def output(self, pin, state):
        """ set the state to an output pin, and carry out hardware
        simulation """
    ...
    def __update_keypad_pin_states(self):
        ...
        if True in self.__key_states:
            ...
            try:
                ...
                pressed_row, pressed_col = list(self.__key_coord.values())[
                    pressed_key_index]
                ...
                # set the input pin state to True according to the connected
                # lines
